...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Moringa-SDF-PT10/reagan-nyauma-trivia-project.git
   ```
...
![quiz configuration page](./assets/configuration-page.png)

- Quiz loading after "START QUIZ" is clicked

![quiz loading](./assets/quiz-loading.png)
...
![correct answer](./assets/correct-answer-sample.png)

- Notification after selecting the wrong answer

![wrong answer](./assets/wrong-answer-sample.png)

- Notification after running out of time

![timeout](./assets/timeout-sample.png)

- Results page after attempting at least one question

![results](./assets/results-sample.png)
